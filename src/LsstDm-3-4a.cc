...
[LsstDm-3-4a - 3]
Global function names must start with lowercase letter (camelCase) 
...
This Rule only checks that global function name starts with a lowercase letter;
    it does not check for camelCase, verb usage, or parenthesis positioning.

Member function name usage is checked in LsstDm-3-4b
